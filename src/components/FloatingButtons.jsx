...
export default function FloatingButtons() {
    ...
    const waLink = `https://wa.me/${ADMIN_WHATSAPP}?text=${encodeURIComponent(
        'Halo, saya ingin bertanya tentang produk parfum Anda.'
    )}`
        ...
        <div style={{
            ...
            <button
                ...
                style={{
                    ...
                    transform: showBackToTop ? 'translateY(0) scale(1)' : 'translateY(10px) scale(0.8)',
                ...
                onMouseLeave={e => {
                    e.currentTarget.style.background = 'rgba(11,13,20,0.85)'
